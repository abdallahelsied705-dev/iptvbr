...
export const routes: RouteDefinition[] = [
  ...
  { ...define("/blog/app-iptv-fecha-sozinha/", "blog", "app iptv fecha sozinha", "App IPTV Fecha Sozinha: Causas e Soluções", "Diagnóstico para aplicações IPTV que encerram inesperadamente por memória, espaço, calor, versão ou incompatibilidade.", "/blog/", "informational"), publishedAt: "2026-09-30T09:00:00Z" },
  { ...define("/blog/epg-hora-errada/", "blog", "epg hora errada", "EPG com Hora Errada: Como Corrigir o Guia IPTV", "Corrige horários adiantados ou atrasados através do fuso, horário de verão, offset e associação de canais.", "/blog/", "informational"), publishedAt: "2026-10-01T09:00:00Z" },
  { ...define("/blog/lista-m3u-nao-carrega/", "blog", "lista m3u não carrega", "Lista M3U Não Carrega: Diagnóstico Seguro", "Passos para separar erros de URL, acesso, rede, player e recursos sem expor credenciais da playlist.", "/blog/", "informational"), publishedAt: "2026-10-02T09:00:00Z" },
  { ...define("/blog/imagem-iptv-pixelizada/", "blog", "imagem iptv pixelizada", "Imagem IPTV Pixelizada: Rede, Bitrate ou Player?", "Aprende a distinguir compressão, bitrate baixo, interferência Wi-Fi, descodificação e processamento da televisão.", "/blog/", "informational"), publishedAt: "2026-10-03T09:00:00Z" },
  { ...define("/blog/audio-video-dessincronizado-iptv/", "blog", "áudio vídeo dessincronizado iptv", "Áudio e Vídeo Dessincronizados no IPTV", "Guia para medir e corrigir atraso entre áudio e imagem no player, Bluetooth, soundbar e HDMI.", "/blog/", "informational"), publishedAt: "2026-10-04T09:00:00Z" },
  { ...define("/blog/iptv-televisao-antiga/", "blog", "iptv televisão antiga", "IPTV numa Televisão Antiga: Opções Simples", "Como usar box ou stick numa televisão antiga, configurar HDMI, resolução, energia, rede e comando.", "/blog/", "informational"), publishedAt: "2026-10-05T09:00:00Z" },
  { ...define("/blog/fire-tv-vs-android-tv-box/", "blog", "fire tv vs android tv box", "Fire TV vs Android TV Box para IPTV", "Comparação entre ecossistemas, aplicações, portas, Ethernet, desempenho, atualizações e perfis de utilização.", "/blog/", "informational"), publishedAt: "2026-10-06T09:00:00Z" },
  { ...define("/blog/firestick-armazenamento-cheio/", "blog", "firestick armazenamento cheio", "Fire TV Stick sem Espaço: Como Libertar Armazenamento", "Liberta espaço com segurança, distingue cache de dados e decide quando precisas de outro equipamento.", "/blog/", "informational"), publishedAt: "2026-10-07T09:00:00Z" },
  { ...define("/blog/iptv-pc-vlc/", "blog", "iptv pc vlc", "IPTV no PC com VLC: Configuração e Diagnóstico", "Como usar VLC com fontes legítimas, proteger playlists e testar rede, codecs, buffer e saída HDMI.", "/blog/", "informational"), publishedAt: "2026-10-08T09:00:00Z" },
  { ...define("/blog/testar-estabilidade-iptv/", "blog", "testar estabilidade iptv", "Como Testar a Estabilidade do IPTV Antes de Escolher", "Método prático para avaliar reprodução, rede, EPG, suporte, compatibilidade e condições antes de decidir.", "/blog/", "informational"), publishedAt: "2026-10-09T09:00:00Z" },
  { ...define("/blog/app-iptv-nao-aparece-smart-tv/", "blog", "app iptv não aparece smart tv", "App IPTV Não Aparece na Smart TV: O Que Fazer", "Descobre por que uma aplicação não aparece na loja da televisão e compara atualização, região, compatibilidade e box externa.", "/blog/", "informational"), publishedAt: "2026-10-10T09:00:00Z" },
  { ...define("/blog/chromecast-nao-liga-iptv/", "blog", "chromecast não liga iptv", "Chromecast Não Liga ao IPTV: Diagnóstico", "Resolve falhas de descoberta e reprodução no Chromecast através de rede local, permissões, codecs e Mesh.", "/blog/", "informational"), publishedAt: "2026-10-11T09:00:00Z" },
  { ...define("/blog/comando-nao-funciona-app-iptv/", "blog", "comando não funciona app iptv", "Comando Não Funciona na App IPTV", "Como diagnosticar foco, Bluetooth, infravermelhos, emparelhamento e interfaces que não foram concebidas para TV.", "/blog/", "informational"), publishedAt: "2026-10-12T09:00:00Z" },
  { ...define("/blog/iptv-desliga-a-cada-minutos/", "blog", "iptv desliga a cada minutos", "IPTV Desliga Após Alguns Minutos: Causas", "Identifica interrupções periódicas causadas por suspensão, energia, rede, temperatura, sessão ou ligações simultâneas.", "/blog/", "informational"), publishedAt: "2026-10-13T09:00:00Z" },
  { ...define("/blog/favoritos-iptv-desapareceram/", "blog", "favoritos iptv desapareceram", "Favoritos IPTV Desapareceram: Como Recuperar", "Entende armazenamento local, perfis, atualizações de lista, backups e formas seguras de reconstruir favoritos.", "/blog/", "informational"), publishedAt: "2026-10-14T09:00:00Z" },
  { ...define("/blog/organizar-canais-iptv/", "blog", "organizar canais iptv", "Como Organizar Canais IPTV e Favoritos", "Cria grupos úteis, oculta categorias, gere duplicados e mantém uma organização simples no player.", "/blog/", "informational"), publishedAt: "2026-10-15T09:00:00Z" },
  { ...define("/blog/vpn-deixa-iptv-lento/", "blog", "vpn deixa iptv lento", "VPN Deixa IPTV Lento? Como Testar", "Mede o efeito de servidor, protocolo, distância e hardware na velocidade e latência do streaming.", "/blog/", "informational"), publishedAt: "2026-10-16T09:00:00Z" },
  { ...define("/blog/erro-de-rede-iptv/", "blog", "erro de rede iptv", "Erro de Rede no IPTV: Diagnóstico por Etapas", "Separa falhas de Internet, DNS, certificados, firewall, VPN e servidor sem repor o router por impulso.", "/blog/", "informational"), publishedAt: "2026-10-17T09:00:00Z" },
  { ...define("/blog/atualizar-app-iptv-seguranca/", "blog", "atualizar app iptv segurança", "Como Atualizar uma App IPTV com Segurança", "Atualiza pela origem correta, protege configuração, revê permissões e testa antes de replicar em todos os dispositivos.", "/blog/", "informational"), publishedAt: "2026-10-18T09:00:00Z" },
  { ...define("/blog/iptv-varios-ecras-simultaneo/", "blog", "iptv vários ecrãs simultâneo", "IPTV em Vários Ecrãs ao Mesmo Tempo", "Distingue dispositivos instalados de ligações simultâneas e calcula rede, perfis e plano adequado à casa.", "/blog/", "informational"), publishedAt: "2026-10-19T09:00:00Z" },
];
