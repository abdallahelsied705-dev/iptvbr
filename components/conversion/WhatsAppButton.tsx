...
export function WhatsAppButton({ message = "Olá, gostaria de obter informações sobre a IPTVBR." }: { message?: string }) {
  return (
    ...
    >
      <span className="whatsapp-icon whatsapp-icon-svg"><WhatsAppIcon /></span>
      Falar no WhatsApp
    </Link>
  );
}