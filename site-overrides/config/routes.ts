...
export const routes: RouteDefinition[] = [
  ...
  { ...define("/blog/como-escolher-uma-app-iptv/", "blog", "como escolher uma app iptv", "Como Escolher uma App IPTV", "Critérios práticos para comparar aplicações IPTV por dispositivo, interface, configuração e manutenção.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/iptv-no-smart-tv/", "blog", "iptv smart tv guia", "IPTV na Smart TV: O Que Preparar Antes da Configuração", "Um guia editorial sobre os pontos a validar antes de configurar IPTV numa Smart TV.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/iptv-no-firestick/", "blog", "iptv firestick guia", "IPTV no Fire TV Stick: Roteiro de Configuração", "Roteiro editorial para preparar dispositivo, aplicação, dados de acesso e diagnóstico no Fire TV Stick.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/iptv-buffering-causas/", "blog", "iptv buffering causas", "IPTV com Buffering: As Causas Mais Comuns", "Como separar causas relacionadas com rede, aplicação, dispositivo e reprodução quando existe buffering.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/m3u-vs-xtream-codes/", "blog", "m3u vs xtream codes", "M3U vs Xtream Codes: Qual é a Diferença?", "Comparação técnica entre dois formatos de configuração usados por aplicações que suportam IPTV.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/o-que-e-epg/", "blog", "o que é epg iptv", "O Que é EPG e Para Que Serve no IPTV?", "Explicação prática sobre EPG, guia de programação, fontes de dados e diagnóstico básico.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/velocidade-internet-iptv/", "blog", "velocidade internet iptv", "Que Internet é Precisa para IPTV?", "Como avaliar velocidade, estabilidade e condições de rede para uma experiência de streaming mais consistente.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
  { ...define("/blog/iptv-legalidade-portugal/", "blog", "iptv legalidade portugal", "IPTV e Legalidade em Portugal: O Que Distinguir", "Um artigo explicativo sobre a diferença entre tecnologia IPTV e autorização para distribuir conteúdos protegidos.", "/blog/", "informational"), image: "/images/hero/iptv-portugal-streaming.svg" },
